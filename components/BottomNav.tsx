    ...
    return (
        <nav className="bg-gray-800/80 backdrop-blur-sm border-t border-gray-700 relative">
            <div className="container mx-auto max-w-4xl flex justify-around items-center h-16">
                ...
                <NavButton label="Learn" icon={<LearnIcon />} isActive={currentView === 'learn'} onClick={() => setCurrentView('learn')} />
                <NavButton label="Market" icon={<MarketplaceIcon />} isActive={currentView === 'listings'} onClick={() => setCurrentView('listings')} />
