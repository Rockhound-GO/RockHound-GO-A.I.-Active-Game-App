    ...
    <header className="bg-gray-900/80 backdrop-blur-sm shadow-lg p-4 border-b border-gray-700 z-10 relative">
      <div className="container mx-auto flex items-center justify-between gap-2">
        <div className="flex items-center flex-shrink min-w-0">
            ...
            <h1 className="text-xl sm:text-3xl font-bold tracking-wider text-white truncate">
            ROCKHOUND GO
            </h1>
        </div>
        <div className="flex items-center space-x-4">
            <div className="flex flex-col items-end">
                ...
                <span className="text-xl sm:text-2xl font-bold text-amber-300">{score.toLocaleString()}</span>
            </div>
